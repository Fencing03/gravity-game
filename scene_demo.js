...
var test_1 = false; test_2 = false; test_3 = false; test_4 = false; test_5 = false; test_6 = false; test_7 = false; test_8 = false; test_9 = false; test_10 = false;
var test_11 = false; test_12 = false; test_13 = false; test_14 = false; test_15 = false; test_16 = false; test_17 = false; test_18 = false; test_19 = false; test_20 = false;
...
class scene_demo extends Phaser.Scene{
    constructor(){
        super({key : 'scene_demo'})
    }
...
////////////////////////////////////////////////////////////////
        ...
        this.case_bleu_demo = this.add.sprite(position_fleche_v + 2*64 +5, position_fleche_h + 2*64 -12, 'case1', 0)
        this.case_vert_demo = this.add.sprite(position_fleche_v + 1*64 +5, position_fleche_h + 6*64 -12, 'case2', 0)
        this.case_obj_demo = this.add.sprite(position_fleche_v + 3*64 +5, position_fleche_h + 4*64 -12, 'case_obj', 0)
        this.case_bleu_demo.alpha = 0.05
        this.case_vert_demo.alpha = 0.05
        this.case_obj_demo.alpha = 0.05
...
this.physics.add.collider(this.pion1, this.pion2, (pion1, pion2) =>  {
    ...
    if(this.physics.collide(this.pion1, this.MurGroupv )){
        ...
        if(((pion1_influx_gauche || pion1_influx_gauche2) && test_right == true) || ((pion1_influx_droite || pion1_influx_droite2) && test_left == true)){}
    ...
    if(this.physics.collide(this.pion1, this.MurGrouph )){
        if(((pion1_influx_haut || pion1_influx_haut2) && test_down == true) || ((pion1_influx_bas || pion1_influx_bas2) && test_up == true)){}
    ...
    if(this.physics.collide(this.pion2, this.MurGroupv )){
        if(((pion2_influx_gauche || pion2_influx_gauche2) && test_right == true) || ((pion2_influx_droite || pion2_influx_droite2) && test_left == true)){}
    ...
    if(this.physics.collide(this.pion2, this.MurGrouph)){
        if(((pion2_influx_haut || pion2_influx_haut2) && test_down == true) || ((pion2_influx_bas || pion2_influx_bas2) && test_up == true)){}
...
this.timer_1 = this.time.addEvent({
    delay: 200, callback: function() {test_1 = true}})

this.timer_2 = this.time.addEvent({
    delay: 400, callback: function() {test_2 = true}})

this.timer_3 = this.time.addEvent({
    delay: 600, callback: function() {test_3 = true}})

this.timer_4 = this.time.addEvent({
    delay: 800, callback: function() {test_4 = true}})

this.timer_5 = this.time.addEvent({
    delay: 1000, callback: function() {test_5 = true}})

this.timer_6 = this.time.addEvent({
    delay: 1200, callback: function() {test_6 = true}})
        
this.timer_7 = this.time.addEvent({
    delay: 1400, callback: function() {test_7 = true}})

this.timer_8 = this.time.addEvent({
    delay: 1600, callback: function() {test_8 = true}})
            
this.timer_9 = this.time.addEvent({
    delay: 1800, callback: function() {test_9 = true}})
...
this.timer_2
if(test_2 == true){
    this.case_obj_demo.alpha = 0.3
    //no_tour += 1
}

this.timer_3
if(test_3 == true){
    obj_x_init = position_fleche_v + 3*64 +5 ; obj_y_init = position_fleche_h + 4*64 -12;
    test_case_obj = true
    this.case_obj_demo.alpha = 0.05
}
...
this.timer_4
if(test_4 == true){
    this.case_vert_demo.alpha = 1
}

this.timer_5
if(test_5 == true){
    pion2_x_init = position_fleche_v + 1*64 +5 ; pion2_y_init = position_fleche_h + 6*64 -3;
    test_case_pion1 = true
    this.case_vert_demo.alpha = 0.05
}
...
this.timer_6
if(test_6 == true){
    this.case_bleu_demo.alpha = 0.6
}

this.timer_7
if(test_7 == true){
    pion1_x_init = position_fleche_v + 2*64 +5 ; pion1_y_init = position_fleche_h + 2*64 -3;
    test_case_pion2 = true
    this.case_bleu_demo.alpha = 0.05   
}
...
if((this.pion2.body.gravity.y > 0 || this.pion2.body.gravity.y < 0) && pion2_influx_droite == false  && pion2_influx_gauche == false && pion2_influx_droite2 == false  && pion2_influx_gauche2 == false){
    for(let step = 0; step < 8; step++){
        ...
        {this.pion2.x = position_flux_v + step*64.1}
...
// pion2 /////////////////////////
       ...
       contact_lim_droite = false
    ...
    else if(this.pion2.y < 153 && (this.pion2.body.gravity.y < 0 || pion2_influx_haut  == true|| pion2_influx_haut2 == true)){
        ...
        this.pion2.y = position_flux_v + 64*7 + 8
        this.pion2.body.gravity.y = gravity2_y
        contact_lim_haut = false
    }}
    else if(this.pion2.y > 615 && (this.pion2.body.gravity.y > 0 || pion2_influx_bas == true || pion2_influx_bas2 == true)){
...
if(debug2 == true){
    this.fluxgauche_vert7.alpha = 1;  
   // this.fluxgauche_vert8.alpha = 0;
   // this.fluxgauche_vert1.alpha = 0;
   // this.fluxgauche_vert2.alpha = 0
}
if(debug1 == true){
   this.fluxgauche_vert8.alpha = 1;  
   //this.fluxgauche_vert7.alpha = 0;
   //this.fluxgauche_vert1.alpha = 0;
  // this.fluxgauche_vert2.alpha = 0
}
